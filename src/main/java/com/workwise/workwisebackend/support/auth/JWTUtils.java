...
public class JWTUtils {
    ...
    public String extractJwtToken(String authorizationHeader) {
        ...
        // Estrai e restituisci solo il token JWT, rimuovendo "Bearer " e spazi bianchi
        return extractUsername(authorizationHeader.substring(7).trim()); // "Bearer " ha lunghezza 7
    }
}